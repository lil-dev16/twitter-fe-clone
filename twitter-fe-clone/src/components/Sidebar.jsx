...
const Sidebar = () => {
    return(
       <div className="md:h-full flex md:flex-col flex-row bg-[red] justify-between bottom-0 fixed left-0 w-fit md:relative  p-[2rem]">
          <div className="md:block hidden w-10">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="r-13v1u17 r-4qtqp9 r-yyyyoo r-16y2uox r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp"><g><path d="M23.643 4.937c-.835.37-1.732.62-2.675.733.962-.576 1.7-1.49 2.048-2.578-.9.534-1.897.922-2.958 1.13-.85-.904-2.06-1.47-3.4-1.47-2.572 0-4.658 2.086-4.658 4.66 0 .364.042.718.12 1.06-3.873-.195-7.304-2.05-9.602-4.868-.4.69-.63 1.49-.63 2.342 0 1.616.823 3.043 2.072 3.878-.764-.025-1.482-.234-2.11-.583v.06c0 2.257 1.605 4.14 3.737 4.568-.392.106-.803.162-1.227.162-.3 0-.593-.028-.877-.082.593 1.85 2.313 3.198 4.352 3.234-1.595 1.25-3.604 1.995-5.786 1.995-.376 0-.747-.022-1.112-.065 2.062 1.323 4.51 2.093 7.14 2.093 8.57 0 13.255-7.098 13.255-13.254 0-.2-.005-.402-.014-.602.91-.658 1.7-1.477 2.323-2.41z"></path></g></svg>
          </div>
          <div>
            <div className="justify-between flex flex-row md:flex-col">
          <div className="block md:mb-[30px] flex ">
            <svg viewBox="0 0 24 24" className=" w-10 fill-white mr-5"><g><path d="M12 1.696L.622 8.807l1.06 1.696L3 9.679V19.5C3 20.881 4.119 22 5.5 22h13c1.381 0 2.5-1.119 2.5-2.5V9.679l1.318.824 1.06-1.696L12 1.696zM12 16.5c-1.933 0-3.5-1.567-3.5-3.5s1.567-3.5 3.5-3.5 3.5 1.567 3.5 3.5-1.567 3.5-3.5 3.5z"></path></g></svg>
            <h3 className="text-2xl xl:block hidden">Home</h3>
          </div>
          <div className="block md:mb-[30px] flex ">
            <div>
            <svg viewBox="0 0 24 24" aria-hidden="true" className="w-10 mr-5"><g><path d="M10.09 3.098L9.72 7h5.99l.39-4.089 1.99.187L17.72 7h3.78v2h-3.97l-.56 6h3.53v2h-3.72l-.38 4.089-1.99-.187.36-3.902H8.78l-.38 4.089-1.99-.187L6.77 17H2.5v-2h4.46l.56-6H3.5V7h4.21l.39-4.089 1.99.187zM14.96 15l.56-6H9.53l-.56 6h5.99z"></path></g></svg>
            </div>
            <h3 className="text-2xl xl:block hidden">Explore</h3>
          </div>
          <div className="block  md:mb-[30px] flex ">
            <svg viewBox="0 0 24 24" aria-hidden="true" className=" mr-5 w-10 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M7.501 19.917L7.471 21H.472l.029-1.027c.184-6.618 3.736-8.977 7-8.977.963 0 1.95.212 2.87.672-.444.478-.851 1.03-1.212 1.656-.507-.204-1.054-.329-1.658-.329-2.767 0-4.57 2.223-4.938 6.004H7.56c-.023.302-.05.599-.059.917zm15.998.056L23.528 21H9.472l.029-1.027c.184-6.618 3.736-8.977 7-8.977s6.816 2.358 7 8.977zM21.437 19c-.367-3.781-2.17-6.004-4.938-6.004s-4.57 2.223-4.938 6.004h9.875zm-4.938-9c-.799 0-1.527-.279-2.116-.73-.836-.64-1.384-1.638-1.384-2.77 0-1.93 1.567-3.5 3.5-3.5s3.5 1.57 3.5 3.5c0 1.132-.548 2.13-1.384 2.77-.589.451-1.317.73-2.116.73zm-1.5-3.5c0 .827.673 1.5 1.5 1.5s1.5-.673 1.5-1.5-.673-1.5-1.5-1.5-1.5.673-1.5 1.5zM7.5 3C9.433 3 11 4.57 11 6.5S9.433 10 7.5 10 4 8.43 4 6.5 5.567 3 7.5 3zm0 2C6.673 5 6 5.673 6 6.5S6.673 8 7.5 8 9 7.327 9 6.5 8.327 5 7.5 5z"></path></g></svg>
            <h3 className="text-2xl xl:block hidden">Communities</h3>
          </div>
          <div className="block md:mb-[30px] flex ">
            ...
            <h3 className="text-2xl xl:block hidden">Notifications</h3>
          </div>
          <div className="block md:mb-[30px] flex ">
            ...
            <h3 className="text-2xl xl:block hidden">Messages</h3>
          </div>
          <div className="md:flex hidden md:mb-[30px] ">
            ...
            <h3 className="text-2xl xl:block hidden">Bookmarks</h3>
          </div>
          <div className="md:flex hidden md:mb-[30px] ">
            ...
            <h3 className="text-2xl xl:block hidden">Twitter Blue</h3>
          </div>
          <div className="md:flex hidden md:mb-[30px]  ">
            ...
            <h3 className="text-2xl xl:block hidden">Profile</h3>
          </div>
          <div className="md:flex hidden  md:mb-[30px]  ">
            ...
            <h3 className="text-2xl xl:block hidden">More</h3>
          </div>
             </div>
             <div className="block w-10 md:mb-[30px]">
               <svg viewBox="0 0 24 24" aria-hidden="true" className="mr-5 w-10 r-jwli3a r-4qtqp9 r-yyyyoo r-1472mwg r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp"><g><path d="M23 3c-6.62-.1-10.38 2.421-13.05 6.03C7.29 12.61 6 17.331 6 22h2c0-1.007.07-2.012.19-3H12c4.1 0 7.48-3.082 7.94-7.054C22.79 10.147 23.17 6.359 23 3zm-7 8h-1.5v2H16c.63-.016 1.2-.08 1.72-.188C16.95 15.24 14.68 17 12 17H8.55c.57-2.512 1.57-4.851 3-6.78 2.16-2.912 5.29-4.911 9.45-5.187C20.95 8.079 19.9 11 16 11zM4 9V6H1V4h3V1h2v3h3v2H6v3H4z"></path></g></svg>
             </div>
         </div>
