...
const Sidebar = () => {
    return(
       <div className="md:h-full flex md:flex-col flex-row bg-[red] justify-between bottom-0 fixed left-0 w-full md:relative  p-[2rem]">
          ...
          <div className="md:block hidden w-10 md:mb-[30px]">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"></path></g></svg>
          </div>
          <div className="md:block hidden w-10 md:mb-[30px]">
