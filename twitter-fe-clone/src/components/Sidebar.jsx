    ...
    return(
       <div className="md:h-[100vh] overflow-scroll items-center flex md:flex-col flex-row bg-[red] justify-center md:justify-between bottom-0 fixed left-0 w-full md:w-fit md:relative  px-[1rem]">
          ...
          <div className="flex justify-between w-full relative">
            <div className="justify-between flex flex-row md:flex-col w-full">
          <div className="block md:mb-[22px] flex justify-center xl:justify-start">
            <svg viewBox="0 0 24 24" className=" w-6 fill-white "><g><path d="M12 1.696L.622 8.807l1.06 1.696L3 9.679V19.5C3 20.881 4.119 22 5.5 22h13c1.381 0 2.5-1.119 2.5-2.5V9.679l1.318.824 1.06-1.696L12 1.696zM12 16.5c-1.933 0-3.5-1.567-3.5-3.5s1.567-3.5 3.5-3.5 3.5 1.567 3.5 3.5-1.567 3.5-3.5 3.5z"></path></g></svg>
            <h3 className="text-2xl xl:block hidden ml-5">Home</h3>
          </div>
          <div className="block md:mb-[30px] flex  justify-center xl:justify-start">
            <div>
            <svg viewBox="0 0 24 24" aria-hidden="true" className="w-6 fill-white"><g><path d="M10.09 3.098L9.72 7h5.99l.39-4.089 1.99.187L17.72 7h3.78v2h-3.97l-.56 6h3.53v2h-3.72l-.38 4.089-1.99-.187.36-3.902H8.78l-.38 4.089-1.99-.187L6.77 17H2.5v-2h4.46l.56-6H3.5V7h4.21l.39-4.089 1.99.187zM14.96 15l.56-6H9.53l-.56 6h5.99z"></path></g></svg>
            </div>
            <h3 className="text-2xl xl:block hidden ml-5">Explore</h3>
          </div>
          <div className="block  md:mb-[30px] flex  justify-center xl:justify-start">
            <svg viewBox="0 0 24 24" aria-hidden="true" className=" w-6 fill-white "><g><path d="M7.501 19.917L7.471 21H.472l.029-1.027c.184-6.618 3.736-8.977 7-8.977.963 0 1.95.212 2.87.672-.444.478-.851 1.03-1.212 1.656-.507-.204-1.054-.329-1.658-.329-2.767 0-4.57 2.223-4.938 6.004H7.56c-.023.302-.05.599-.059.917zm15.998.056L23.528 21H9.472l.029-1.027c.184-6.618 3.736-8.977 7-8.977s6.816 2.358 7 8.977zM21.437 19c-.367-3.781-2.17-6.004-4.938-6.004s-4.57 2.223-4.938 6.004h9.875zm-4.938-9c-.799 0-1.527-.279-2.116-.73-.836-.64-1.384-1.638-1.384-2.77 0-1.93 1.567-3.5 3.5-3.5s3.5 1.57 3.5 3.5c0 1.132-.548 2.13-1.384 2.77-.589.451-1.317.73-2.116.73zm-1.5-3.5c0 .827.673 1.5 1.5 1.5s1.5-.673 1.5-1.5-.673-1.5-1.5-1.5-1.5.673-1.5 1.5zM7.5 3C9.433 3 11 4.57 11 6.5S9.433 10 7.5 10 4 8.43 4 6.5 5.567 3 7.5 3zm0 2C6.673 5 6 5.673 6 6.5S6.673 8 7.5 8 9 7.327 9 6.5 8.327 5 7.5 5z"></path></g></svg>
            <h3 className="text-2xl xl:block hidden ml-5">Communities</h3>
          </div>
          <div className="block md:mb-[30px] flex  justify-center xl:justify-start">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="  w-6 fill-white"><g><path d="M19.993 9.042C19.48 5.017 16.054 2 11.996 2s-7.49 3.021-7.999 7.051L2.866 18H7.1c.463 2.282 2.481 4 4.9 4s4.437-1.718 4.9-4h4.236l-1.143-8.958zM12 20c-1.306 0-2.417-.835-2.829-2h5.658c-.412 1.165-1.523 2-2.829 2zm-6.866-4l.847-6.698C6.364 6.272 8.941 4 11.996 4s5.627 2.268 6.013 5.295L18.864 16H5.134z"></path></g></svg>
            <h3 className="text-2xl xl:block hidden ml-5">Notifications</h3>
          </div>
          <div className="block md:mb-[30px] flex  justify-center xl:justify-start">
